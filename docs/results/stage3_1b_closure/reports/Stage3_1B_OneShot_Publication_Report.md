...
protocol ablation                           check       status     value                                                                                            threshold_or_expectation                                                                                 note
   ...
   treat     full    placebo_window_null_post_all   diagnostic  0.254949       directional placebo p<=0.05 indicates real event-aligned effect is stronger than random fake event boundaries                    observed_delta=0.1340, null_mean=0.0995, null_ci=[0.0062, 0.2094]
```
